...
This package contains the architecture and the first working HyDB foundations.
...
The package provides typed schema definitions,
...
contracts. The in-memory authoritative database is next.
