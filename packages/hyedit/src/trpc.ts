...
import type { HyeditModelOption } from "./models.js";

export interface HyeditContext {}

const t = initTRPC.context<HyeditContext>().create();
...
export function createHyeditRouter(
...
export type HyeditRouter = ReturnType<typeof createHyeditRouter>;
